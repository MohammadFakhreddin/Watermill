...
namespace MFA
{
    ...
    public:
        ...
        // Used to notify the other object about the collision. Does not do anything on itself
        using OnHit = std::function<void(Layer, void * userData)>;
        ...
        // Define colors for different layers (up to 16 layers)
        static constexpr glm::vec4 layerColors[] = {
            glm::vec4(1.0f, 0.0f, 0.0f, 1.0f),    // Red - Layer 0
            glm::vec4(0.0f, 1.0f, 0.0f, 1.0f),    // Green - Layer 1
            glm::vec4(0.0f, 0.0f, 1.0f, 1.0f),    // Blue - Layer 2
            glm::vec4(1.0f, 1.0f, 0.0f, 1.0f),    // Yellow - Layer 3
            glm::vec4(1.0f, 0.0f, 1.0f, 1.0f),    // Magenta - Layer 4
            glm::vec4(0.0f, 1.0f, 1.0f, 1.0f),    // Cyan - Layer 5
            glm::vec4(1.0f, 0.5f, 0.0f, 1.0f),    // Orange - Layer 6
            glm::vec4(0.5f, 0.0f, 1.0f, 1.0f),    // Purple - Layer 7
            glm::vec4(0.0f, 0.5f, 0.0f, 1.0f),    // Dark Green - Layer 8
            glm::vec4(0.5f, 0.5f, 0.0f, 1.0f),    // Olive - Layer 9
            glm::vec4(0.0f, 0.5f, 0.5f, 1.0f),    // Teal - Layer 10
            glm::vec4(0.5f, 0.0f, 0.5f, 1.0f),    // Dark Magenta - Layer 11
            glm::vec4(1.0f, 0.75f, 0.5f, 1.0f),   // Peach - Layer 12
            glm::vec4(0.5f, 0.75f, 1.0f, 1.0f),   // Light Blue - Layer 13
            glm::vec4(0.75f, 0.5f, 1.0f, 1.0f),   // Lavender - Layer 14
            glm::vec4(0.75f, 0.75f, 0.75f, 1.0f)  // Light Gray - Layer 15
        };

        static constexpr size_t numLayers = std::size(layerColors);
