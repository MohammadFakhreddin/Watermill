	...
	void SolidFillPipeline::CreatePipeline()
	{
		{// Vertex shader
			bool success = Importer::CompileShaderToSPV(
				Path::Instance()->Get("shaders/solid_fill_pipeline/SolidFillPipeline.vert.hlsl"),
				Path::Instance()->Get("shaders/solid_fill_pipeline/SolidFillPipeline.vert.spv"),
				"vert"
			);
		...
		{// Fragment shader
			bool success = Importer::CompileShaderToSPV(
				Path::Instance()->Get("shaders/solid_fill_pipeline/SolidFillPipeline.frag.hlsl"),
				Path::Instance()->Get("shaders/solid_fill_pipeline/SolidFillPipeline.frag.spv"),
				"frag"
			);
			MFA_ASSERT(success == true);
		}
